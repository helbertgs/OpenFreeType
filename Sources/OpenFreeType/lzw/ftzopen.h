...
/* `FT_LOCAL` and friends live in internal compiler macros.  This header is
 * internal to FreeType (not a public installed header), and it is included
 * before other internal headers in `ftzopen.c`, so ensure the macros exist.
 */
